	...
	<div class="container">
		...
		<div class="row">
			<ul class="nav nav-tabs">
					...
					<li class="pull-right"><a class="text-muted">PROMEDIO CALIFICACIÓN: 3.5 |
						
						<i class="fa fa-star text-succes"></i>	
						<i class="fa fa-star text-succes"></i>	
						<i class="fa fa-star text-succes"></i>	
						<i class="fa fa-star-half-o text-succes"></i>	
						<i class="fa fa-star-o text-succes"></i>	
		...
		<div class="row comentarios">
			...
			<div class="panel-group col-md-3 col-sm-6 col-xs-12">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body"><small>Lorem ipsufjkalsfdjañlsdfkjalñsdfkjalsdfkad
					ñslfkjadslfasd fsdafasdf fdasdfadsf</small></div>
...
<div class="container-fluid productos">
			...
			<?php
				...
				$ordenar = 
				$ordenar, $item, $valor, $base, $tope, $modo;
