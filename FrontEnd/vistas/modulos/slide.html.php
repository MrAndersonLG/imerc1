	...
	<div class="row">
		...
		<ul>
			...
			<li>
				...
				<img src="http://localhost/ecomerce/BackEnd/vistas/img/slide/default/back_default.jpg" alt="">

				<div class="slideOpciones slideOpcion1">
					
					<img class="imgProducto" src="http://localhost/ecomerce/BackEnd/vistas/img/slide/slide1/calzado.png" style="top:15%; right:10%; width:45%">
			...
			<li>
				...
				<div class="slideOpciones slideOpcion2">
					...
					<img class="imgProducto" src="http://localhost/ecomerce/BackEnd/vistas/img/slide/slide2/curso.png" style="top:5%; left:15%; width:25%">
			...
			<li>
				...
				<img src="http://localhost/ecomerce/BackEnd/vistas/img/slide/slide3/fondo2.jpg" alt="">

				<div class="slideOpciones slideOpcion2">
					
					<img class="imgProducto" src="http://localhost/ecomerce/BackEnd/vistas/img/slide/slide3/iphone.png" style="top:5%; left:15%; width:25%">
			...
			<li>
				...
				<img src="http://localhost/ecomerce/BackEnd/vistas/img/slide/slide4/fondo3.jpg" alt="">
