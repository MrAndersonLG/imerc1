		...
		<center>
			...
			<?php
				...
				if(count($listaProductos) != 0){
					...
					$pagProductos = ceil(count($listaProductos)/12); // El método ceil redondea hacia el numero entero mayor					
					...
					if($pagProductos > 4){
					 ...
					 LOS BOTONES DE LAS PRIMERAS 4 PAGINAS Y LA ULTIMA PAGINA
						...
						/*=============================================
					 	 LOS BOTONES DE LA MIDAD DE PAGINAS HACIA ABAJO
						=============================================*/
						...
						/*=============================================
					 	 LOS BOTONES DE LA MIDAD DE PAGINAS HACIA ARRIBA
						=============================================*/
