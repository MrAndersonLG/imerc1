...
function avanzar(){
var valorCaja = $("#slide ul li");
//alert(valorCaja.lenght);
 
	if(item == valorCaja.length - 1){
...
function movimientoSlide(item){
	...
	$("#slide ul").animate({"left": item * -100 + "%"}, 1000, "easeOutQuart") //el ultimo valor es el tiempo de cambio
